            ...
            <figure>
              ...
              <figcaption class="mt-6 text-base text-white">
                <div class="pb-4 space-x-2">
                  ...
                  <UBadge v-if="Object.keys(nextMatchedUser?.preferences || {}).length === 0" color="white"
                    variant="outline">#BoringPerson</UBadge>
                </div>
...
const nextMatchedUser = useDocument<User>(doc(collection(firestore, 'users'), user.value?.uid))
</script>
